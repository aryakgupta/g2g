...
function html_form_code() {  
    ...
    echo '<p>';
    echo 'Message <br/>';
    echo '<textarea name="cf-comments" size="40" rows="4" placeholder="Enter your message" style="resize: none;"/>' . ( isset( $_POST["cf-comments"] ) ? esc_attr( $_POST["cf-comments"] ) : '' ) . '</textarea>';
    echo '</p>';
    echo '<p>';
