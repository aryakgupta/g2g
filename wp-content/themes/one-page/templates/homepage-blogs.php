    ...
    <div class="blog_div">
        <div class="container">
            ...
            <div class="row homepage_blogs" data-masonry>
				...
				$no_of_post = $blog['onepage_blog_post_number'];
				$args = array(
					'post_type' => 'post',
				...
				if ( $query->have_posts() ) :
					while ( $query->have_posts() ) :
						$query->the_post();
						?>
						<div class="col-md-4 post_item_wrapper" style="width:99%" >
							<div class="post animated zoom_in homepage_post" style="animation-delay: <?php (.4 * $i) ?>s">
								...
								<p><?php echo substr( get_the_excerpt(), 0, 500 ); ?> <a class="read_more1" href="<?php the_permalink() ?>"><?php echo onepage_get_option( 'onepage_blog_read_more_text', __( 'Read More', 'one-page' ) ); ?></a></p>
