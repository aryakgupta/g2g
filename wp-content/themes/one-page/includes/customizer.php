...
class Onepage_Customizer {
	...
	public static function Onepage_Sections( $wp_customize ) {
		/**
		 * Set priority for the title tag
		 */
		 ...
		 * Typography section
		 */
		$wp_customize->add_section( 'onepage_typography_section', array(
		 ...
		 */
//        $wp_customize->add_panel('onepage_homepage_section', array(
//            'title' => __('Homepage Settings', 'one-page'),
//            'description' => __('Allows you to change settings of Homepage for OnePage Theme.', 'one-page'), //Descriptive tooltip
//            'priority' => '11',
//            'capability' => 'edit_theme_options'
//                )
//        );
		 ...
		 */
		$wp_customize->add_section( 'onepage_hp_custom_section', array(
			'title' => __( 'Homepage Custom Section', 'one-page' ),
		 ...
		 * Theme setting 
		 */
		$wp_customize->add_panel( 'onepage_theme_settings', array(
		 ...
		 * Layout settings
		 */
		$wp_customize->add_section( 'onepage_theme_layout_setting', array(
			'title' => __( 'Theme Layout Settings', 'one-page' ),
			'description' => '', //Descriptive tooltip
			'panel' => 'onepage_theme_settings',
			'priority' => '10',
			'capability' => 'edit_theme_options'
				)
		);
		 ...
		 * Sidebar settings
		 */
		$wp_customize->add_section( 'onepage_theme_sidebar_setting', array(
			'title' => __( 'Sidebar Settings', 'one-page' ),
			'description' => '', //Descriptive tooltip
			'panel' => 'onepage_theme_settings',
			'priority' => '11',
			'capability' => 'edit_theme_options'
		...
		$wp_customize->add_section( 'onepage_theme_dummy_data', array(
			'title' => __( 'Theme Dummy Data', 'one-page' ),
			'description' => '', //Descriptive tooltip
			'panel' => 'onepage_theme_settings',
			'priority' => '11',
			'capability' => 'edit_theme_options'
...
//            'priority' => '11',
		 ...
		 */
		$wp_customize->add_section( 'onepage_unlimited_team_shortcode', array(
...
//            'priority' => '11',
		...
		$wp_customize->add_section( 'footer_sidebar_on_off', array(
			'title' => __( 'Footer Sidebar On/Off', 'one-page' ),
			'description' => '', //Descriptive tooltip
...
//            'priority' => '11',
		...
		/**
		 *  Footer Bottom On/Off
		 */
		$wp_customize->add_section( 'footer_bottom_on_off', array(
			'title' => __( 'Footer Bottom On/Off', 'one-page' ),
			'description' => '', //Descriptive tooltip
		...
		/**
		 *  Footer Section Social Icon Shortcode
		 */
		$wp_customize->add_section( 'footer_social_icon_shortcode', array(
			'title' => __( 'Footer Section Unlimlited Social Icon Shortcode', 'one-page' ),
			'description' => '', //Descriptive tooltip
			'panel' => 'footer_setting_panel',
			'priority' => '11',
			'capability' => 'edit_theme_options'
...
//            'priority' => '11',
	...
	public static function Onepage_Section_Content() {
		$section_content = array(
			'header_setting_panel' => array(
				...
				'onepage_header_positon_upgrade',
				'onepage_header_ad'
			),
			'header_top_setting_panel' => array(
				...
				'onepage_ln_link',
				'onepage_header_unlimited_SIcons_upgrade'
			),
			...
			'onepage_typography_section' => array(
				'onepage_typography_update'
			),
			'onepage_sort_section' => array(
				'onepage_section_order',
			),
			'onepage_hp_custom_section' => array(
				'onepage_hp_custom_sec_update'
			),
			'onepage_theme_layout_setting' => array(
				'onepage_theme_layout_update'
			),
			'onepage_theme_sidebar_setting' => array(
				'onepage_theme_sidebar_update'
			),
			'onepage_theme_dummy_data' => array(
				'onepage_theme_show_dummy_data'
			),
			...
			'onepage_unlimited_team_shortcode' => array(
			 ...
			 */
			'footer_sidebar_on_off' => array(
				'footer_sidebar_on_off_upgrade'
			),
			 ...
			 */
			'footer_bottom_on_off' => array(
				'footer_bottom_on_off_upgrade'
			),
			'footer_social_icon_shortcode' => array(
				'footer_social_icon_shortcode_upgrade'
			),
	...
	public static function Onepage_Settings() {
		...
		$onepage_settings = array(
			...
			'onepage_header_positon_upgrade' => array(
				'id' => 'onepage_options[onepage_header_positon_upgrade]',
				'label' => __( 'Header Position', 'one-page' ),
				'description' => sprintf( __( "Check out the <a href='%s' target='_blank'>PRO version </a>for full control over Header Position!", 'one-page' ), esc_url( 'https://www.inkthemes.com/wp-themes/free-one-page-wordpress-theme/' ) ),
				'type' => 'option',
				'setting_type' => 'upgrade_msg2',
				'default' => ''
			),
...
You can refer the codes from links below. %s', 'one-page' ) . '<br>' . esc_attr( 'Write icon class only. e.g, for bootstrap glyphicon&nbsp;write&nbsp;"glyphicon-eye-open" & for font awesome&nbsp;write&nbsp;"fa fa-book"' ), '<a href="https://fortawesome.github.io/Font-Awesome/icons/">https://fortawesome.github.io/Font-Awesome/icons/</a>,<br/><a href="http://getbootstrap.com/components/">http://getbootstrap.com/components/</a>' ),
			...
			'onepage_header_unlimited_SIcons_upgrade' => array(
				'id' => 'onepage_options[onepage_header_unlimited_SIcons_upgrade]',
				'label' => __( 'Header Section Social Icon Shortcode', 'one-page' ),
				'description' => sprintf( __( "Check out the <a href='%s' target='_blank'>PRO version </a>for full control over unlimited social icon for Header Section!", 'one-page' ), esc_url( 'https://www.inkthemes.com/wp-themes/free-one-page-wordpress-theme/' ) ),
				'type' => 'option',
				'setting_type' => 'upgrade_msg2',
				'default' => ''
			),
			 ...
			 * Typography section
			 */
			'onepage_typography_update' => array(
				'id' => 'onepage_options[onepage_typography_update]',
				'description' => sprintf( __( "Check out the <a href='%s' target='_blank'>PRO version </a>for full control over Typography!", 'one-page' ), esc_url( 'https://www.inkthemes.com/wp-themes/free-one-page-wordpress-theme/' ) ),
				'setting_type' => 'upgrade_msg'
			),
			/**
			 * One-page section
			 */
			 ...
			 * Custom section
			 */
			'onepage_hp_custom_sec_update' => array(
				'id' => 'onepage_options[onepage_hp_custom_sec_update]',
				'description' => sprintf( __( "Check out the <a href='%s' target='_blank'>PRO version </a>for full control over Homepage Custom Section!", 'one-page' ), esc_url( 'https://www.inkthemes.com/wp-themes/free-one-page-wordpress-theme/' ) ),
				'setting_type' => 'upgrade_msg'
			),
			/**
			 * Layout Settings
			 */
			'onepage_theme_layout_update' => array(
				'id' => 'onepage_options[onepage_theme_layout_update]',
				'description' => sprintf( __( "Check out the <a href='%s' target='_blank'>PRO version </a>for full control over the layout of the theme!", 'one-page' ), esc_url( 'https://www.inkthemes.com/wp-themes/free-one-page-wordpress-theme/' ) ),
				'setting_type' => 'upgrade_msg'
			),
			/**
			 * Sidebar Settings
			 */
			'onepage_theme_sidebar_update' => array(
				'id' => 'onepage_options[onepage_theme_sidebar_update]',
				'description' => sprintf( __( "Check out the <a href='%s' target='_blank'>PRO version </a>for full control over the position of the sidebar!", 'one-page' ), esc_url( 'https://www.inkthemes.com/wp-themes/free-one-page-wordpress-theme/' ) ),
				'setting_type' => 'upgrade_msg'
			),
			'onepage_theme_show_dummy_data' => array(
				'id' => 'onepage_options[onepage_showdummy]',
				'label' => __( 'Show Dummy Data', 'one-page' ),
				'type' => 'option',
				'description' => __( "Check the box if you want to see your site with dummy data.", 'one-page' ),
...
You can refer the codes from links below. %s', 'one-page' ) . '<br>' . esc_attr( 'Write icon class only. e.g, for bootstrap glyphicon&nbsp;write&nbsp;"glyphicon-eye-open" & for font awesome&nbsp;write&nbsp;"fa fa-book"' ), '<a href="https://fortawesome.github.io/Font-Awesome/icons/">https://fortawesome.github.io/Font-Awesome/icons/</a>,<br/><a href="http://getbootstrap.com/components/">http://getbootstrap.com/components/</a>' ),
			...
			/**
			 * Unlimited Team Member shortcode
			 */
			'onepage_unlimited_team_shortcode_upgrade' => array(
				'id' => 'onepage_options[onepage_unlimited_team_shortcode_upgrade]',
				'description' => sprintf( __( "Check out the <a href='%s' target='_blank'>PRO version </a>for full control over unlimited Team Members!", 'one-page' ), esc_url( 'https://www.inkthemes.com/wp-themes/free-one-page-wordpress-theme/' ) ),
				'setting_type' => 'upgrade_msg'
			),
			/**
			 * Contact panel settings
			...
			'onepage_contact_msg_heading' => array(
				'id' => 'onepage_options[onepage_contact_msg_heading]',
				'label' => __( 'Sub-Heading', 'one-page' ),
				'description' => __( 'Write msg-heading for the contact section', 'one-page' ),
				'type' => 'option',
				'setting_type' => 'text',
				'default' => ''
			),
			 ...
			 * Footer sidebar panel settings
			 */
			'footer_sidebar_on_off_upgrade' => array(
				'id' => 'onepage_options[footer_sidebar_on_off_upgrade]',
				'description' => sprintf( __( "Check out the <a href='%s' target='_blank'>PRO version </a>for full control over footer sidebar!", 'one-page' ), esc_url( 'https://www.inkthemes.com/wp-themes/free-one-page-wordpress-theme/' ) ),
				'setting_type' => 'upgrade_msg'
			),
			 ...
			 * Footer panel settings
			 */
			'footer_bottom_on_off_upgrade' => array(
				'id' => 'onepage_options[footer_bottom_on_off_upgrade]',
				'description' => sprintf( __( "Check out the <a href='%s' target='_blank'>PRO version </a>for full control over Footer Bottom Section!", 'one-page' ), esc_url( 'https://www.inkthemes.com/wp-themes/free-one-page-wordpress-theme/' ) ),
				'setting_type' => 'upgrade_msg'
			),
			'footer_social_icon_shortcode_upgrade' => array(
				'id' => 'onepage_options[footer_social_icon_shortcode_upgrade]',
				'description' => sprintf( __( "Check out the <a href='%s' target='_blank'>PRO version </a>for full control over unlimited footer section social icons!", 'one-page' ), esc_url( 'https://www.inkthemes.com/wp-themes/free-one-page-wordpress-theme/' ) ),
				'setting_type' => 'upgrade_msg'
			),
		...
		foreach ( $sections as $section_id => $section_content ) {
			foreach ( $section_content as $section_content_id ) {
				switch ( $settings[$section_content_id]['setting_type'] ) {
					...
					case 'upgrade_msg':
						self::add_setting( $wp_customize, $settings[$section_content_id]['id'], '', '', 'onepage_sanitize_text' );
						$wp_customize->add_control( new Onepage_Upgrade_control(
								$wp_customize, $settings[$section_content_id]['id'], array(
							'label' => '',
							'description' => $settings[$section_content_id]['description'],
							'section' => $section_id,
					...
					case 'upgrade_msg2':
						self::add_setting( $wp_customize, $settings[$section_content_id]['id'], '', '', 'onepage_sanitize_text' );
						$wp_customize->add_control( new Onepage_Upgrade_control2(
								$wp_customize, $settings[$section_content_id]['id'], array(
							'label' => $settings[$section_content_id]['label'],
							'description' => $settings[$section_content_id]['description'],
							'section' => $section_id,
